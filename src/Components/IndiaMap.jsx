...
// //         {/* Display PDF links */}
// //         {selectedState && (
// //           <div className="demo w-auto border-2 h-full flex items-center justify-center overflow-y-auto">
// //             <div className="select w-full sm:h-full lg:h-screen max-w-md md:max-w-xl lg:max-w-3xl p-6 rounded-lg shadow-2xl  bg-white relative">
...
//       {/* Ensure the map takes up remaining available space */}
//       <div className="flex-grow flex">
//         <div
//           id="chartdiv"
//           className="w-full h-full md:h-[70vh] lg:h-[80vh] xl:h-[85vh] border-4 border-pink-300 rounded-lg shadow-lg mb-4"
//         ></div>
